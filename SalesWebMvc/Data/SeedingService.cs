...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //DB has been seed (Seed means = populado)
            }
            ...
            Seller s1 = new Seller(1, "Bob Browm", "bob@gmail.com", new DateTime(1998, 4, 12), 1000.00, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.00, d3);
            Seller s3 = new Seller(3, "Alex Gray", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.00, d1);
